...
biryani += mk_item("Hyderabadi Veg Dum Biryani", "16.59", "A medley of fresh vegetables layered with aromatic basmati rice and dum cooked with subtle spices.", veg=True)
biryani += """
    </div>
</section>
<section class="menu-section">
